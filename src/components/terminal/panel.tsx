...
export function Panel({
  ...
  return (
    <section
      className={cn(
        "min-h-0 overflow-hidden border border-[#2b3139] bg-[#11161c] shadow-[0_0_0_1px_rgba(0,0,0,0.18)]",
        className,
      )}
    >
      {children}
...
export function PanelBody({
  ...
  return <div className={cn("min-h-0 overflow-auto p-2", className)}>{children}</div>;
}
